...
then
  ...
  sudo curl -o /etc/systemd/system/hello-relpath.service https://raw.githubusercontent.com/BRReed/scripts/breed/change-home-dir/orchestration/node-apps/hello-world/hello-relpath.service
fi
